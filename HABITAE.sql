...
('12345678000199', 34, '60070080091', 'Aluguel', 'Comercial', 'Sala grande em Recife'),
...
-- 14. Geração do backup do banco de dados
-- Comando para exportar (executar no terminal):
-- mysqldump -u [usuário] -p HABITAE > backup_habitae.sql
